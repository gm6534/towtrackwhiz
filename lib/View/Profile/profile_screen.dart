                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "${Strings.youHaveHelpedVerify} ${int.parse(controller.currentUser.value.totalVerifiedCount ?? "0") > 0 ? controller.currentUser.value.totalVerifiedCount : 0} ${Strings.communityAlerts}",
